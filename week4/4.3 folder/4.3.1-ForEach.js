...
// answer = [];
// data.forEach((item, index) => answer[index] = [item.address.geo.lat, item.address.geo.lng]);
// console.log(answer);
...
//   if ((item.company.name == "" && item.company.bs == "") == true) {
//     answer[index] = ["Nada"];
//   } else {
//     answer[index] = [`${item.company.name}: ${item.company.bs}`]
//   }
// });
// console.log(answer);
